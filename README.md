...
| **MFE Bucket Deployment** | Builds and deploys Micro-Frontend apps to AWS S3 with ease.          | [.github/workflows/mfe-bucket-deployment.yml](./.github/workflows/mfe-bucket-deployment.yml) |
